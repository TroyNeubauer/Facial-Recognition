...
struct ImGuiIO
{
    ...
    bool        KeysDown[1024];                  // Keyboard keys that are pressed (ideally left in the "native" order your engine has access to keyboard keys, so you can use your own defines/enums for keys).
    ...
    float       KeysDownDuration[1024];          // Duration the keyboard key has been down (0.0f == just pressed)
    float       KeysDownDurationPrev[1024];      // Previous duration the key has been down
